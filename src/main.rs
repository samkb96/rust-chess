...
async fn main() {
    run_gui(DOUBLE_CHECK_A7E5_E5F7_E8E7_D1D7).await;
}

// perft mode for debugging / performance testing; accessed with cargo perft
#[cfg(feature = "perft")]
fn main() {
    call_perft(DOUBLE_CHECK_A7E5_E5F7_E8E7_D1D7, 2)
}

// START POSITION CONSTANTS

// difference at depth 2. bb misfire after f8b4
const DOUBLE_CHECK: &str =
    "rnbqkb1r/pppp1ppp/5n2/4N3/4P3/8/PPP2PPP/RNBQKB1R b KQkq - 0 4";

// PROBLEM HERE. Only legal moves are to take the queen
// king can only take queen, but all other pieces ignoring the check

const DOUBLE_CHECK_A7E5_E5F7_E8E7_D1D7: &str =
    "rnbq1b1r/1ppQkNpp/5n2/p7/4P3/8/PPP2PPP/RNB1KB1R b KQ - 0 6";
