...
use crate::engine_handler::{Bot, SearchEngine, Evaluator, Evaluation, SearchData};
...
impl Evaluator for NullEvaluator {
    ...
    fn evaluate(&self, _side_to_move: &PieceColour, _search_state: &GameState, _search_data: &mut SearchData) -> Evaluation {
        0
    }
}
...
impl Evaluator for PieceValues {
    ...
    fn evaluate(&self, side_to_move: &PieceColour, search_state: &GameState, _search_data: &mut SearchData) -> Evaluation {
